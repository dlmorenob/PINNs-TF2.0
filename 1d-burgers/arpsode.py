...
dir     = sys.path[0]
eqnPath   = os.path.join(mycudir,"1d-burgers")
utilsPath = os.path.join(mycudir,"utils")
...
print("modelo resuelto con metodos numericos")
print(path)
...
### After matching the data using regularization
### a forecast is performed to understand the difference
